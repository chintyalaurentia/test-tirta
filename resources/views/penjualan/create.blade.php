...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h3>Penjualan - {{ ($data['form'] == 'create') ? 'Create' : 'Edit' }}</h3>
        </div>
    </div>


    <form id="formInput" class="needs-validation" novalidate action="{{ ($data['form'] == 'create') ? route('penjualan.store') : route('penjualan.update', $data['dataModel']->kode_toko) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
    @csrf
        <div class="card">
            <div class="card-header d-flex align-items-center jusitfy-content-between"><b><i class="fa fa-solid fa-clock mr-2"></i>{{ ($data['form'] == 'create') ? 'Create' : 'Edit' }} Penjualan</b>
                <div class="btn-group ml-auto" role="group" aria-label="Basic example">
                    <a class="btn btn-outline-dark btn-sm" href="{{ route('penjualan.index') }}" role="button"><i class="fa fa-solid fa-angle-left"></i> Back</a>
                    <button type="submit" class="btn btn-dark btn-sm" id="save"><i class="fa fa-solid fa-save"></i> Save</button>
                </div>
            </div>
            <div class="card-body">
                ...
                @if($data['form'] == 'edit')
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" name="kode" id="kode" value="{{ ($data['form'] == 'create') ? "" : $data['dataModel']->kode_toko }}"required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" name="nominal" id="nominal" value="{{ ($data['form'] == 'create') ? "" : $data['dataModel']->nominal_transaksi }}" required>
                            </div>
                        </div>
                    </div>
                @else
                        ...
                        <div class="card mt-3 rowFrekuensi" data-row="1">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group has-validation">
                                            <input type="text" class="form-control" name="nominal[]" id="nominal" value="{{ ($data['form'] == 'create') ? "" : $data['val']->Nama }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <a href="{{ asset('Penjualan.xlsx') }}" type="button" id="import-template" class="btn btn-sm btn-outline-secondary" title="Download File Template">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#tambah', function() {
            ...
            <div class="card mt-3 rowFrekuensi" data-row="'+curr_id+'" id="frekuensi'+curr_id+'">\
                <div class="card-header d-flex align-items-center jusitfy-content-between">\
                    <strong id="titleFrek">Penjualan '+length+'</strong>\
                ...
                <div class="card-body">\
                    ...
                    <div class="row mb-3">\
                        ...
                        <div class="col-md-9">\
                            <div class="input-group has-validation">\
                                <input type="text" class="form-control" name="nominal[]" id="nominal'+curr_id+'" required>\
                            </div>\
                        </div>\
                    </div>\
                </div>\
                ...
                success: function (response) {
                    if(response.success){
                        ...
                        result.forEach(element => {
                            ...
                            $('#nominal'+curr_row).val(element[2]);
                            curr_row += 1;
                        });
